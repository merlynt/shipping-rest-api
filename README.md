...
* **Framework Base:** .NET 10 (Target Framework: `net10.0`)
* **SDK Mínimo Requerido:** .NET SDK 10.0.202
...
1. **SDK de .NET 10** (Es indispensable contar con la versión 10 para evitar conflictos de compilación).
